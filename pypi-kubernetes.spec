...
Source0  : https://files.pythonhosted.org/packages/82/3c/9f29f6cab7f35df8e54f019e5719465fa97b877be2454e99f989270b4f34/kubernetes-30.1.0.tar.gz
...
%prep
%setup -q -n kubernetes-30.1.0
cd %{_builddir}/kubernetes-30.1.0
pushd ..
cp -a kubernetes-30.1.0 buildavx2
popd
pushd ..
cp -a kubernetes-30.1.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717714971
