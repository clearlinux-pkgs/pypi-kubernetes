...
%prep
%setup -q -n kubernetes-32.0.0
cd %{_builddir}/kubernetes-32.0.0
pushd ..
cp -a kubernetes-32.0.0 buildavx2
popd
pushd ..
cp -a kubernetes-32.0.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737731878
