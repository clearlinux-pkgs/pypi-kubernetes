...
%prep
%setup -q -n kubernetes-20.13.0
cd %{_builddir}/kubernetes-20.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639043070
...
cp %{_builddir}/kubernetes-20.13.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-kubernetes/8d27fd734630787bf68266a7f4fb6b4c55cd6853
