...
Source0  : https://files.pythonhosted.org/packages/ae/52/19ebe8004c243fdfa78268a96727c71e08f00ff6fe69a301d0b7fcbce3c2/kubernetes-33.1.0.tar.gz
...
%prep
%setup -q -n kubernetes-33.1.0
cd %{_builddir}/kubernetes-33.1.0
pushd ..
cp -a kubernetes-33.1.0 buildavx2
popd
pushd ..
cp -a kubernetes-33.1.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749568404
