...
Source0  : https://files.pythonhosted.org/packages/de/07/d01320a808abaab3426db63476adcb31f7e23fe8c08aef175d7883ea978a/kubernetes-29.0.0.tar.gz
...
%prep
%setup -q -n kubernetes-29.0.0
cd %{_builddir}/kubernetes-29.0.0
pushd ..
cp -a kubernetes-29.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704820156
