...
Source0  : https://files.pythonhosted.org/packages/34/19/2f351c0eaf05234dc33a6e0ffc7894e9dedab0ff341311c5b4ba44f2d8ac/kubernetes-26.1.0.tar.gz
...
%prep
%setup -q -n kubernetes-26.1.0
cd %{_builddir}/kubernetes-26.1.0
pushd ..
cp -a kubernetes-26.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676516602
