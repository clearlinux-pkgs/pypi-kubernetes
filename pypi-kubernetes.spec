...
Source0  : https://files.pythonhosted.org/packages/d5/a5/e50dbde38d54aa38a191204d6e446c7b41c1ab67354a2f652e971a4b5932/kubernetes-23.6.0.tar.gz
...
%prep
%setup -q -n kubernetes-23.6.0
cd %{_builddir}/kubernetes-23.6.0
pushd ..
cp -a kubernetes-23.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653341370
...
cp %{_builddir}/kubernetes-23.6.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-kubernetes/8d27fd734630787bf68266a7f4fb6b4c55cd6853
